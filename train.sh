...
DATAPATH='/mnt/shared-storage-gpfs2/brainllm2-share/xiaoyu/salmonn_data/Giga1000h_LS960h_lt180WavCaps_AudioCaps_Clotho_train.json'
...
git config --global --add safe.directory /mnt/shared-storage-gpfs2/brainllm2-share/xiaoyu/SALMONN
...
torchrun \
    ...
    train.py \
    --base_llm_path /mnt/shared-storage-user/brainllm-share/checkpoints/Qwen3-8B \
    --llm_type Qwen \
    --deepspeed deepspeed_config/zero2.json \
    ...
    --audio_encoder_path /mnt/shared-storage-user/housiyuan/xiaoyu/workspace/icefall_general_encoder/egs/general_audio_encoder/mtl/zipformer_audio_encoder/exp-600M-uniform-v2-zipformer-out-ds-2-lh-large-giga-xl-vox-all-audio-w2v2-mask-p-0.65-l-10-cha-mask-p-0.25-l-20-multi-mvq-wavlm-large-1.0-dasheng-0.2-only-mask-0-token-mix-prob-0.2-p-n-0.5-delay-1.5-md400/iter-500000-avg-4.pt \
