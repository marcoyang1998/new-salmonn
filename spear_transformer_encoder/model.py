...
class MultiKDModel(nn.Module):
    def __init__(
        ...
        # TODO: fix this
        self.num_encoder_layers = encoder.num_layers
    ...
    def forward_encoder(
        ...
        output = self.encoder(x, x_lens, output_hidden_states=True)
        encoder_out = output.last_hidden_state
        all_hidden_states = output.hidden_states

        return encoder_out, x_lens, all_hidden_states
    ...
    def forward(
        ...
        # Compute encoder outputs
        encoder_out, all_hidden_states, encoder_out_lens = self.forward_encoder(x, x_lens)
...
def get_spear_transformer_encoder_600M():
    from .subsampling import Conv2dSubsampling
    from .transformer_encoder import LlamaAudioEncoder
    encoder_embed = Conv2dSubsampling(idim=128, odim=1280)
