...
def load_qwen_model():
    ...
    model_name = "/mnt/shared-storage-gpfs2/gpfs2-shared-public/huggingface/hub/models--Qwen--Qwen2.5-7B-Instruct/snapshots/a09a35458c702b33eeacc393d103063234e8bc28"
...
def load_nvembed_model():
    ...
    model_id = "/mnt/shared-storage-gpfs2/brainllm2-share/xiaoyu/models/models--nvidia--NV-Embed-v2/snapshots/3fa59658547db50a1e8e3346cf057fd0c77ed6ef/"
    # model_id = "/mnt/shared-storage-gpfs2/brainllm2-share/xiaoyu/models/NV-Embed-v2"
...
def main():
    ...
    # Save results
    os.makedirs('output_mmau_pro', exist_ok=True)
    output_filename = os.path.join('output_mmau_pro', f'{input_filename}_comprehensive_results.json')
